...
val PastelBlue = Color(0xFF6DCCFF)
val PaleBlue = Color(0xFFE6F5FF)
val LightPastelBlue = Color(0xFF95E1FF)
val DarkPastelBlue = Color(0xFF60A9E1)
val Orange = Color(0xFFFFBB33)
val Yellow = Color(0xFFDDDA1B)