...
import kite1412.irrigo.data.mock.MockLightIntensityRepository
...
interface MockModule {
    ...
    fun bindWaterCapacityRepository(
        impl: MockWaterCapacityRepository
    ...
    fun bindSoilMoistureLogRepository(
        impl: MockSoilMoistureLogRepository
    ): SoilMoistureLogRepository

    @Binds
    @Singleton
    fun bindWateringRepository(
        impl: MockWateringRepository
    ): WateringRepository

    @Binds
    @Singleton
    fun bindLightIntensityLogRepository(
        impl: MockLightIntensityRepository
